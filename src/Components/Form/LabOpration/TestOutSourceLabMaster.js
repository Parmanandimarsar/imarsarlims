    ...
    <div className="mb-[50px] pl-2">
      <Box className="bg-white rounded-lg shadow-lg" autoComplete="off">
        <Box className="flex justify-between items-center mb-1 text-white p-1 rounded-t-lg project-thim">
          <Typography className="pl-1">TestOut Source LabMaster</Typography>
        </Box>
        ...
        <div className="h-[150px] w-full">
          <DataGridTable
            rows={rows}
            columns={TestOutSourceLabMasterColumns(handleDelete, handleEdit)}
          />
        </div>
      </Box>
    </div>
...
export default TestOutSourceLabMaster;
