            ...
            {({ values, setFieldValue, errors, touched }) => (
              <Form>
                ...
                <Box style={{ height: 300, width: "100%" }}>
                  <DataGridTable
                    rows={rows}
                    columns={TATMastercolumns(handleProcessRowUpdate)} // Call TATMastercolumns as a function
                    editMode={true}
                    processRowUpdate={handleProcessRowUpdate} // Ensure processRowUpdate prop is set
                  />
                </Box>
