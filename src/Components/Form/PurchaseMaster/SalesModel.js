  ...
  return (
    <>
      <div className=" mb-[50px] pl-2">
        <Box
          className="bg-white p-1 rounded-lg shadow-lg border"
          autoComplete="off"
        >
          <Box className="flex justify-between items-center">
            <Typography>Sales Model</Typography>
          </Box>
                      ...
                      <Grid container alignItems="center">
                        ...
                        <Grid item xs={8}>
                          <Field
                            ...
                            size="small"
                            error={
                              touched.financierName && !!errors.financierName
                            }
                          >
                            <MenuItem value="">Select Financier</MenuItem>
                            <MenuItem value="financier1">Financier 1</MenuItem>
                            <MenuItem value="financier2">Financier 2</MenuItem>
                          </Field>
                          <ErrorMessage
                            name="financierName"
                            component="div"
