...
import { MasterDiscountApproval } from "../../../TableField/TablefieldsColumns";
...
const DiscountApprovalMaster = () => {
  ...
  const validationSchema = Yup.object().shape({
    discountapproval: Yup.string().required("Rate type is required"),
  });
  ...
  const onSubmit = (values, { setSubmitting, resetForm }) => {
    if (editRow) {
      ...
      setRows([
        ...
        {
          id: rows.length + 1,
          discountapproval: values.discountapproval,
          ...values,
        },
      ]);
    }
  ...
  const exportToExcel = () => {
    const headers = ["S.No", "Discount Approval Master", "Active"];
    ...
    ExportToExcel(data, headers, "Discount_Approval_Master.xlsx");
  };
            ...
            <Form className="p-1">
                      ...
                      <Grid item xs={6}>
                        <FormControl fullWidth>
                          <Field
                            ...
                            size="small"
                            error={
                              touched.discountapproval &&
                              !!errors.discountapproval
                            }
                          ></Field>
                          <ErrorMessage
                            name="discountapproval"
              ...
              <div className="h-[150px] w-full">
                <DataGrid
                  ...
                  rows={handleFilter()}
                  columns={MasterDiscountApproval(
                    handleToggleActive,
                    handleEdit,
                    Switch
                  )}
