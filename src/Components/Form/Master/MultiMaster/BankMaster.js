...
import { MasterBankColumns } from "../../../TableField/TablefieldsColumns";
...
const BankMaster = () => {
  ...
  const validationSchema = Yup.object().shape({
    bankmaster: Yup.string().required("Rate type is required"),
  ...
  const exportToExcel = () => {
    const headers = ["S.No", "Bank Master",  "Active"];
    ...
    ExportToExcel(data, headers, "bank_master.xlsx");
  };
                  ...
                  <FormControl fullWidth>
                    <Grid container alignItems="center">
                      <Grid
                        ...
                        sx={{ mr: "3px" }}
                      >
                        <FormLabel>Bank Master</FormLabel>
                      </Grid>
                      <Grid item xs={6}>
                        <FormControl fullWidth>
                          <Field
                            ...
                            name="bankmaster"
                            fullWidth
                            placeholder="Enter Bank Master "
                            size="small"
                            error={
                              touched.bankmaster && !!errors.bankmaster
                            }
                          ></Field>
                          <ErrorMessage
                            name="bankmaster"
