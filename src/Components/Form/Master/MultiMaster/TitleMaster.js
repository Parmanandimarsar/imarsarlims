...
import { MasterTitleColumns } from "../../../TableField/TablefieldsColumns";
...
const TitleMaster = () => {
  ...
  const validationSchema = Yup.object().shape({
    titlemaster: Yup.string().required("Rate type is required"),
  });
  ...
  const onSubmit = (values, { setSubmitting, resetForm }) => {
    if (editRow) {
      ...
      setRows([
        ...
        {
          id: rows.length + 1,
          titlemaster: values.titlemaster,
          ...values,
        },
      ]);
    }
  ...
  const exportToExcel = () => {
    const headers = ["S.No", "Title Master", "Active"];
    ...
    ExportToExcel(data, headers, "Title_Master.xlsx");
  };
                  ...
                  <FormControl fullWidth>
                    <Grid container alignItems="center">
                      <Grid
                        ...
                        sx={{ mr: "3px" }}
                      >
                        <FormLabel>Title Master</FormLabel>
                      </Grid>
                      <Grid item xs={6}>
                        <FormControl fullWidth>
                          <Field
                            ...
                            name="titlemaster"
                            fullWidth
                            placeholder="Enter Title Master "
                            size="small"
                            error={touched.titlemaster && !!errors.titlemaster}
                          ></Field>
                          <ErrorMessage
                            name="titlemaster"
                            component="div"
