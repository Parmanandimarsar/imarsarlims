...
import { MasterSampleRejectionMaster } from "../../../TableField/TablefieldsColumns";
...
const SampleRejectionMaster = () => {
  ...
  const validationSchema = Yup.object().shape({
    samplerejection: Yup.string().required("discount type is required"),
  });
  ...
  const onSubmit = (values, { setSubmitting, resetForm }) => {
    if (editRow) {
      ...
      setRows([
        ...
        {
          id: rows.length + 1,
          samplerejection: values.samplerejection,
          ...values,
        },
      ]);
    }
  ...
  const exportToExcel = () => {
    const headers = ["S.No", "Sample Rejection Master", "Active"];
    ...
    ExportToExcel(data, headers, "Sample_Rejection_Master.xlsx");
  };
            ...
            <Form className="p-1">
                  ...
                  <FormControl fullWidth>
                    <Grid container alignItems="center">
                      <Grid
                        ...
                        sx={{ mr: "3px" }}
                      >
                        <FormLabel>Sample Rejection Master</FormLabel>
                      </Grid>
                      <Grid item xs={6}>
                        <FormControl fullWidth>
                          <Field
                            ...
                            fullWidth
                            placeholder="Enter Sample Rejection Master "
                            size="small"
                            error={
                              touched.samplerejection && !!errors.samplerejection
                            }
                          ></Field>
                          <ErrorMessage
                            name="samplerejection"
              ...
              <div className="h-[150px] w-full">
                <DataGrid
                  ...
                  rows={handleFilter()}
                  columns={MasterSampleRejectionMaster(
                    handleToggleActive,
                    handleEdit,
                    Switch
                  )}
