...
import { MasterSampleRemarksColumns } from "../../../TableField/TablefieldsColumns";
...
const SampleRemarksMaster = () => {
  ...
  const validationSchema = Yup.object().shape({
    sampleremarks: Yup.string().required("discount type is required"),
  });
  ...
  const onSubmit = (values, { setSubmitting, resetForm }) => {
    if (editRow) {
      ...
      setRows([
        ...
        {
          id: rows.length + 1,
          sampleremarks: values.sampleremarks,
          ...values,
        },
      ]);
    }
  ...
  const exportToExcel = () => {
    const headers = ["S.No", "Sample Remarks Master", "Active"];
    ...
    ExportToExcel(data, headers, "Sample_Remarks_Master.xlsx");
  };
              ...
              <Form className="p-1">
                    ...
                    <FormControl fullWidth>
                      <Grid container alignItems="center">
                        <Grid
                          ...
                          sx={{ mr: "3px" }}
                        >
                          <FormLabel>Sample Remarks Master</FormLabel>
                        </Grid>
                        <Grid item xs={6}>
                          <FormControl fullWidth>
                            <Field
                              ...
                              name="sampleremarks"
                              fullWidth
                              placeholder="Enter Sample Remarks Master "
                              size="small"
                              error={
                                touched.sampleremarks && !!errors.sampleremarks
                              }
                            ></Field>
                            <ErrorMessage
                              name="sampleremarks"
                ...
                <div className="h-[150px] w-full">
                  <DataGrid
                    ...
                    rows={handleFilter()}
                    columns={MasterSampleRemarksColumns(
                      handleToggleActive,
                      handleEdit,
                      Switch
                    )}
...
export default SampleRemarksMaster;
