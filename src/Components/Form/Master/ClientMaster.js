                        ...
                        <Grid item xs={8}>
                          <FormControl fullWidth>
                            <Field
                              ...
                              size="small"
                              error={
                                touched.processingLab && !!errors.processingLab
                              }
                            >
                              <MenuItem value="" disabled>
                                Select
                      ...
                      <Grid item xs={8}>
                        <FormControl fullWidth>
                          <Field
                            ...
                            size="small"
                            error={
                              touched.centreMobileNo && !!errors.centreMobileNo
                            }
                          />
                          <ErrorMessage
                            name="centreMobileNo"
                      ...
                      <Grid item xs={8}>
                        <FormControl fullWidth>
                          <Field
                            ...
                            size="small"
                            error={
                              touched.centreAddress1 && !!errors.centreAddress1
                            }
                          />
                          <ErrorMessage
                            name="centreAddress1"
                      ...
                      <Grid item xs={8}>
                        <FormControl fullWidth>
                          <Field
                            ...
                            size="small"
                            error={
                              touched.minCashBooking && !!errors.minCashBooking
                            }
                          />
                          <ErrorMessage
                            name="minCashBooking"
                      ...
                      <Grid item xs={8}>
                        <FormControl fullWidth>
                          <Field
                            ...
                            variant="outlined"
                            size="small"
                            error={touched.adharCardNo && !!errors.adharCardNo}
                          />
                          <ErrorMessage
                            name="adharCardNo"
                            component="div"
                      ...
                      <Grid item xs={8}>
                        <FormControl fullWidth>
                          <Field
                            ...
                            variant="outlined"
                            size="small"
                            error={touched.reportEmail && !!errors.reportEmail}
                          />
                          <ErrorMessage
                            name="reportEmail"
                            component="div"
                    ...
                    <Grid container alignItems="center">
                      ...
                      <Grid item xs={8}>
                        <Field
                          ...
                          variant="outlined"
                          size="small"
                          error={touched.chequeAmount && !!errors.chequeAmount}
                        />
                        <ErrorMessage
                          name="chequeAmount"
                          component="div"
                ...
                <FormControl fullWidth>
                  <Grid container alignItems="center">
                    <Grid item xs={12}>
                      ...
                      <FormControlLabel
                        control={
                          <Field type="checkbox" name="ac" className="m-2" />
                        }
                        label="AC"
                      />
                    </Grid>
