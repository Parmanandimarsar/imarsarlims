...
export const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { text: "InvestigationTemplateMaster", link: "/investigation-template-master", icon: <MailIcon /> },
        // { text: "Comment Master", link: "/comment-master", icon: <MailIcon /> },
        { text: "Micro Organism Antibiotic Master", link: "/micro-organism-antibiotic-master", icon: <MailIcon /> },
